(function () {
  ...
  var fxEnabled = !isMobile && !reducedMotion;
  ...
  if (fxEnabled && !isTouch) {
    ...
    $$('.magnetic').forEach(function (btn) {
      btn.addEventListener('pointermove', function (e) {
        ...
        btn.style.transform = 'translate(' + ((e.clientX - r.left - r.width / 2) * 0.08) + 'px, ' + ((e.clientY - r.top - r.height / 2) * 0.12) + 'px)';
      });
  ...
  var caseModalData = {
    'realidad-aumentada': {
      ...
      steps: ['Preparación de cartografía GIS, modelos 3D y puntos de interés.', 'Visualización de información territorial sobre el entorno real.', 'Validación en campo, interpretación técnica y comunicación visual.']
    },
    'arqueologia-ar': {
      title: 'Realidad aumentada',
      text: 'Aplicamos realidad aumentada para visualizar datos GIS, modelos 3D e información técnica sobre el entorno real de forma clara y útil.',
    ...
    'catastro-registro': {
      ...
      text: 'Apoyo cartográfico y GIS para Catastro y Registro: GML, IVG, representación gráfica alternativa cuando proceda, revisión geométrica y memoria cartográfica de apoyo.',
      steps: ['Revisión catastral y control geométrico.', 'Comprobación o preparación de GML, IVG y representación gráfica alternativa cuando proceda.', 'Memoria cartográfica y relación de observaciones técnicas.']
    },
    ...
    'gemelo-digital': {
      ...
      text: 'Modelos 3D, para visualizar propuestas, revisar volúmenes, comunicar resultados técnicos y simular escenarios.',
